...
export function SocialLogin() {
  ...
  return (
    <div className="h-[100dvh] flex items-center relative bg-gradient-to-br from-sky-50 to-gray-200">
            ...
            <div className="p-6 sm:p-16">
              <div className="space-y-4">
                ...
                <h2 className="mb-8 text-2xl text-cyan-900 font-bold">
                  Sign in to unlock the <br /> best of MoodMenu.
                </h2>
              </div>
              <div className="mt-16 grid space-y-4">
                <button
                  className={cn(
                    "group h-12 px-6 border-2 border-gray-300 rounded-full transition duration-300 hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100",
