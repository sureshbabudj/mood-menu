    ...
    >
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1 md:col-span-1 space-y-4">
            <Link href="/" className="flex items-center gap-2 group">
              <div className="p-1.5 rounded-lg  transition-colors">
                <img src="/assets/logo.svg" alt="logo" className="w-6 h-6 opacity-70" />
              </div>
          ...
          <div className="space-y-4">
            <h4 className="text-[10px] uppercase tracking-[0.2em] text-orange-300 font-black">Social</h4>
            <div className="flex gap-4">
              {[
                ...
                <Link 
                  key={idx} 
                  href="#" 
                  className={cn("text-slate-500 transition-all hover:scale-110", color)}
                >
                  <Icon size={20} />
                </Link>
              ))}
