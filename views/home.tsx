  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-slate-950">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'url("https://images.unsplash.com/photo-1547592166-23ac45744acd?auto=format&fit=crop&q=80&w=2070")',
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-center lg:text-left space-y-6">
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold text-white tracking-tight leading-tight">
              Feeling <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-rose-400">Hungry?</span> <br />
              Let your mood decide.
            </h1>
            
            <p className="text-lg text-slate-300 max-w-xl mx-auto lg:mx-0">
              Your mood deserves more than takeout. In seconds, we match your vibe to a recipe that gets you. Cook what you’re craving, not just what’s trending.
            </p>
          </div>

          {/* Right Side: The Form Card */}
          <div className="w-full max-w-xl group">
            <div className="relative transition-all duration-500 group-hover:translate-y-[-4px]">
              {/* Card Glow */}
              <div className="absolute -inset-1 bg-gradient-to-r from-orange-500 to-rose-500 rounded-3xl blur opacity-25 group-hover:opacity-50 transition duration-1000"></div>
              ...
              <div className="relative bg-slate-900/80 backdrop-blur-xl border border-white/10 p-8 rounded-3xl shadow-2xl">
                ...
                <div className="mt-6 pt-6 border-t border-white/5 flex items-center justify-center gap-4 text-slate-500 text-xs">
                  <span className="flex items-center gap-1"><Smile size={14} /> Happy</span>
                  <span className="flex items-center gap-1"><Smile size={14} className="rotate-180" /> Tired</span>
                  <span className="flex items-center gap-1"><Sparkles size={14} /> Adventurous</span>
                </div>
              </div>
            </div>
          </div>
