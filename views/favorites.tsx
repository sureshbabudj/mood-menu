...
import { FavoritesSkeleton } from "@/components/loading/skeleton-components";
...
export default function Favorites() {
  ...
  return (
    <div className="container mx-auto max-sm:px-4 py-4">
      <h3
        className="font-sourgummy font-semibold text-xl mb-3"
        style={{
      ...
      <p
        ...
        style={{
          animation: "fade-in 500ms cubic-bezier(0.22, 1, 0.36, 1) forwards",
          opacity: 0,
        }}
      >
      ...
      {isLoading ? (
        ...
        <div className="rounded-2xl border border-orange-400/20 bg-linear-to-br from-orange-500/5 via-orange-500/10 to-transparent p-8 text-center animate-scale-pop max-w-md mx-auto">
          ...
          <p className="text-sm text-muted-foreground mb-6">
            Start exploring recipes and save the ones that make your taste buds
            dance. Each save brings you closer to discovering your perfect meal!
            ✨
          </p>
          <Button
            className="bg-orange-500 hover:bg-orange-400 text-white rounded-full px-8 transition-all hover:scale-105 active:scale-95"
            asChild
          >
            <Link href="/">Discover Your Next Favorite 🍽️</Link>
          </Button>
        </div>
      )}
      ...
      <p className="text-lg my-6 text-center">
        ...
        <Button
          asChild
          className="my-2 text-center bg-orange-500 hover:bg-orange-400"
        >
